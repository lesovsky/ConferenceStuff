...
/* gcc -std=gnu99 -pedantic -I/usr/pgsql-9.6/include -L/usr/pgsql-9.6/lib -o too-many-conns src/too-many-conns.c -lpq */

#define CONNINFO "host = 127.0.0.1 port = 5432 dbname = pgbench user = postgres"
